package com.aman.vanish.scrobbling
...
import com.aman.vanish.core.network.BaseHttpClient
import com.aman.vanish.core.network.CurlLoggingInterceptor
import com.aman.vanish.scrobbling.anilist.data.AniListAuthenticator
import com.aman.vanish.scrobbling.anilist.data.AniListInterceptor
import com.aman.vanish.scrobbling.anilist.domain.AniListScrobbler
import com.aman.vanish.scrobbling.common.data.ScrobblerStorage
...
import com.aman.vanish.scrobbling.common.domain.model.ScrobblerType
import com.aman.vanish.scrobbling.kitsu.data.KitsuAuthenticator
import com.aman.vanish.scrobbling.kitsu.data.KitsuInterceptor
import com.aman.vanish.scrobbling.kitsu.data.KitsuRepository
import com.aman.vanish.scrobbling.kitsu.domain.KitsuScrobbler
import com.aman.vanish.scrobbling.mal.data.MALAuthenticator
import com.aman.vanish.scrobbling.mal.data.MALInterceptor
import com.aman.vanish.scrobbling.mal.domain.MALScrobbler
import com.aman.vanish.scrobbling.shikimori.data.ShikimoriAuthenticator
import com.aman.vanish.scrobbling.shikimori.data.ShikimoriInterceptor
import com.aman.vanish.scrobbling.shikimori.domain.ShikimoriScrobbler
