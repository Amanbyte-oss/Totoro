package com.aman.vanish.scrobbling.kitsu.ui
...
import com.aman.vanish.databinding.ActivityKitsuAuthBinding
...
class KitsuAuthActivity : BaseActivity<ActivityKitsuAuthBinding>(),
	...
	private fun continueAuth() {
		...
		val url = "vanishink://kitsu-auth?code=" + "$email;$password".urlEncoded()
