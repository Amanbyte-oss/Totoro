...
import com.aman.vanish.core.model.LocalMangaSource
...
import com.aman.vanish.core.model.titleResId
import com.aman.vanish.core.nav.ReaderIntent
import com.aman.vanish.core.nav.router
import com.aman.vanish.core.os.AppShortcutManager
...
import com.aman.vanish.core.ui.image.FaviconDrawable
import com.aman.vanish.core.ui.image.TextDrawable
import com.aman.vanish.core.ui.image.TextViewTarget
import com.aman.vanish.core.ui.list.OnListItemClickListener
import com.aman.vanish.core.ui.sheet.BottomSheetCollapseCallback
import com.aman.vanish.core.ui.util.MenuInvalidator
import com.aman.vanish.core.ui.util.ReversibleActionObserver
import com.aman.vanish.core.ui.widgets.ChipsView
import com.aman.vanish.core.util.FileSize
import com.aman.vanish.core.util.LocaleUtils
import com.aman.vanish.core.util.ext.consume
import com.aman.vanish.core.util.ext.copyToClipboard
import com.aman.vanish.core.util.ext.drawableStart
import com.aman.vanish.core.util.ext.end
import com.aman.vanish.core.util.ext.enqueueWith
import com.aman.vanish.core.util.ext.getThemeColor
import com.aman.vanish.core.util.ext.getQuantityStringSafe
import com.aman.vanish.core.util.ext.isAnimationsEnabled
import com.aman.vanish.core.util.ext.isTextTruncated
import com.aman.vanish.core.util.ext.joinToStringWithLimit
...
import com.aman.vanish.core.util.ext.parentView
...
import com.aman.vanish.databinding.ActivityDetailsBinding
import com.aman.vanish.databinding.LayoutDetailsTableBinding
import com.aman.vanish.details.data.MangaDetails
import com.aman.vanish.details.data.ReadingTime
import com.aman.vanish.details.service.MangaPrefetchService
import com.aman.vanish.details.ui.model.ChapterListItem
import com.aman.vanish.details.ui.model.HistoryInfo
import com.aman.vanish.details.ui.scrobbling.ScrobblingItemDecoration
import com.aman.vanish.details.ui.scrobbling.ScrollingInfoAdapter
import com.aman.vanish.download.ui.worker.DownloadStartedObserver
import com.aman.vanish.list.domain.ReadingProgress
...
import com.aman.vanish.list.ui.size.StaticItemSizeResolver
