package com.aman.vanish.remotelist.ui
...
import com.aman.vanish.core.util.ext.getCauseUrl
...
import com.aman.vanish.list.ui.MangaListFragment
...
class RemoteListFragment : MangaListFragment(), FilterCoordinator.Owner, View.OnClickListener {
    ...
    override fun onViewBindingCreated(binding: FragmentListBinding, savedInstanceState: Bundle?) {
        ...
        viewModel.blockedState.observe(viewLifecycleOwner) { blockedEvent ->
            if (blockedEvent != null) {
                binding.swipeRefreshLayout.visibility = View.GONE
                binding.cloudflareBlockedLayout.visibility = View.VISIBLE
                binding.buttonSolve.setOnClickListener {
                    val intent = ManualCaptchaActivity.newIntent(requireContext(), blockedEvent.url, blockedEvent.sourceName)
                ...
                binding.buttonOpenBrowser.setOnClickListener {
                    runCatching {
                        val browserIntent = android.content.Intent(android.content.Intent.ACTION_VIEW, android.net.Uri.parse(blockedEvent.url))
                        startActivity(browserIntent)
                    }
                }
            } else {
                binding.cloudflareBlockedLayout.visibility = View.GONE
