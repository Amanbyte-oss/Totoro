...
import com.aman.vanish.alternatives.ui.AlternativesActivity
import com.aman.vanish.backups.ui.backup.BackupDialogFragment
import com.aman.vanish.backups.ui.restore.RestoreDialogFragment
import com.aman.vanish.bookmarks.ui.AllBookmarksActivity
import com.aman.vanish.browser.BrowserActivity
...
import com.aman.vanish.core.image.CoilMemoryCacheKey
import com.aman.vanish.core.model.FavouriteCategory
import com.aman.vanish.core.model.MangaSourceInfo
import com.aman.vanish.core.model.appUrl
import com.aman.vanish.core.model.getTitle
import com.aman.vanish.core.model.isBroken
import com.aman.vanish.core.model.isLocal
import com.aman.vanish.core.model.parcelable.ParcelableManga
import com.aman.vanish.core.model.parcelable.ParcelableMangaListFilter
import com.aman.vanish.core.model.parcelable.ParcelableMangaPage
import com.aman.vanish.core.network.CommonHeaders
import com.aman.vanish.core.parser.external.ExternalMangaSource
import com.aman.vanish.core.prefs.AppSettings
import com.aman.vanish.core.prefs.ReaderMode
import com.aman.vanish.core.prefs.TriStateOption
import com.aman.vanish.core.ui.dialog.BigButtonsAlertDialog
import com.aman.vanish.core.ui.dialog.ErrorDetailsDialog
import com.aman.vanish.core.ui.dialog.buildAlertDialog
import com.aman.vanish.core.util.ext.connectivityManager
import com.aman.vanish.core.util.ext.findActivity
import com.aman.vanish.core.util.ext.getThemeDrawable
...
import com.aman.vanish.core.util.ext.withArgs
import com.aman.vanish.details.ui.DetailsActivity
import com.aman.vanish.details.ui.pager.ChaptersPagesSheet
import com.aman.vanish.details.ui.related.RelatedMangaActivity
import com.aman.vanish.details.ui.scrobbling.ScrobblingInfoSheet
import com.aman.vanish.download.ui.dialog.DownloadDialogFragment
import com.aman.vanish.download.ui.list.DownloadsActivity
import com.aman.vanish.favourites.ui.FavouritesActivity
import com.aman.vanish.favourites.ui.categories.FavouriteCategoriesActivity
import com.aman.vanish.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import com.aman.vanish.favourites.ui.categories.select.FavoriteDialog
import com.aman.vanish.filter.ui.FilterCoordinator
import com.aman.vanish.filter.ui.sheet.FilterSheetFragment
import com.aman.vanish.filter.ui.tags.TagsCatalogSheet
import com.aman.vanish.history.ui.HistoryActivity
import com.aman.vanish.image.ui.ImageActivity
import com.aman.vanish.list.ui.config.ListConfigBottomSheet
import com.aman.vanish.list.ui.config.ListConfigSection
import com.aman.vanish.local.ui.ImportDialogFragment
import com.aman.vanish.local.ui.info.LocalInfoDialog
import com.aman.vanish.main.ui.MainActivity
import com.aman.vanish.main.ui.welcome.WelcomeSheet
...
import com.aman.vanish.reader.ui.colorfilter.ColorFilterConfigActivity
import com.aman.vanish.reader.ui.config.ReaderConfigSheet
import com.aman.vanish.scrobbling.common.domain.model.ScrobblerService
import com.aman.vanish.scrobbling.common.ui.config.ScrobblerConfigActivity
import com.aman.vanish.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import com.aman.vanish.search.domain.SearchKind
import com.aman.vanish.search.ui.MangaListActivity
import com.aman.vanish.search.ui.multi.SearchActivity
import com.aman.vanish.settings.SettingsActivity
import com.aman.vanish.settings.override.OverrideConfigActivity
import com.aman.vanish.settings.reader.ReaderTapGridConfigActivity
import com.aman.vanish.settings.sources.auth.SourceAuthActivity
import com.aman.vanish.settings.sources.catalog.SourcesCatalogActivity
import com.aman.vanish.settings.storage.MangaDirectorySelectDialog
import com.aman.vanish.settings.storage.directories.MangaDirectoriesActivity
import com.aman.vanish.settings.tracker.categories.TrackerCategoriesConfigSheet
import com.aman.vanish.stats.ui.StatsActivity
import com.aman.vanish.stats.ui.sheet.MangaStatsSheet
import com.aman.vanish.suggestions.ui.SuggestionsActivity
import com.aman.vanish.tracker.ui.updates.UpdatesActivity
import java.io.File
...
class AppRouter private constructor(
    ...
    fun openAiPick() = startActivity(com.aman.vanish.ai.AiPickActivity::class.java)
    ...
    companion object {
        ...
        fun manualCaptchaIntent(
            context: Context,
            exception: CloudFlareProtectedException,
        ): Intent {
            return ManualCaptchaActivity.newIntent(context, exception.url, exception.source)
        }
