...
import com.aman.vanish.core.network.webview.WebViewRequestInterceptorExecutor
...
class MangaLoaderContextImpl @Inject constructor(
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val config = com.aman.vanish.core.network.webview.InterceptionConfig(
            timeoutMs = timeout,
            maxRequests = 100,
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val appConfig = com.aman.vanish.core.network.webview.InterceptionConfig(
