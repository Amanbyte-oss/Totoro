...
import com.aman.vanish.core.os.AppValidator
import com.aman.vanish.core.os.RomCompat
...
import com.aman.vanish.settings.work.WorkScheduleManager
...
open class BaseApp : Application(), Configuration.Provider {
	...
	override fun onCreate() {
		...
		processLifecycleScope.launch(Dispatchers.IO) {
			sourcesRepository.initializeFirstLaunch()
		}
