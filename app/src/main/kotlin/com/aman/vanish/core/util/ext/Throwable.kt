package com.aman.vanish.core.util.ext
...
import com.aman.vanish.core.exceptions.BadBackupFormatException
import com.aman.vanish.core.exceptions.CaughtException
...
import com.aman.vanish.core.exceptions.IncompatiblePluginException
import com.aman.vanish.core.exceptions.InteractiveActionRequiredException
import com.aman.vanish.core.exceptions.NoDataReceivedException
import com.aman.vanish.core.exceptions.NonFileUriException
import com.aman.vanish.core.exceptions.ProxyConfigException
import com.aman.vanish.core.exceptions.SyncApiException
import com.aman.vanish.core.exceptions.UnsupportedFileException
import com.aman.vanish.core.exceptions.UnsupportedSourceException
import com.aman.vanish.core.exceptions.WrapperIOException
...
private fun Throwable.getDisplayMessageOrNull(resources: Resources): String? = when (this) {
    ...
    is IOException -> mapDisplayMessage(message, resources) ?: message
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.aman.vanish/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.aman.vanish/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
