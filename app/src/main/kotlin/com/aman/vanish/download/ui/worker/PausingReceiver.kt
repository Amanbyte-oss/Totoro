...
import com.aman.vanish.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.aman.vanish.download.PAUSE"
		private const val ACTION_RESUME = "com.aman.vanish.download.RESUME"
		private const val ACTION_SKIP = "com.aman.vanish.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.aman.vanish.download.SKIP_ALL"
