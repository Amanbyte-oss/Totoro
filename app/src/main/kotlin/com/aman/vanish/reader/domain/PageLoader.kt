package com.aman.vanish.reader.domain
...
import com.aman.vanish.core.parser.CachingMangaRepository
import com.aman.vanish.core.parser.MangaRepository
import com.aman.vanish.core.prefs.AppSettings
import com.aman.vanish.core.ui.image.TrimTransformation
import com.aman.vanish.core.util.FileSize
import com.aman.vanish.core.util.MimeTypes
import com.aman.vanish.core.util.ext.URI_SCHEME_ZIP
import com.aman.vanish.core.util.ext.cancelChildrenAndJoin
import com.aman.vanish.core.util.ext.compressToPNG
import com.aman.vanish.core.util.ext.ensureRamAtLeast
import com.aman.vanish.core.util.ext.ensureSuccess
import com.aman.vanish.core.util.ext.getCompletionResultOrNull
import com.aman.vanish.core.util.ext.isFileUri
import com.aman.vanish.core.util.ext.isNotEmpty
import com.aman.vanish.core.util.ext.isPowerSaveMode
import com.aman.vanish.core.util.ext.isZipUri
import com.aman.vanish.core.util.ext.lifecycleScope
import com.aman.vanish.core.util.ext.mangaSourceExtra
import com.aman.vanish.core.util.ext.printStackTraceDebug
import com.aman.vanish.core.util.ext.ramAvailable
import com.aman.vanish.core.util.ext.toMimeType
import com.aman.vanish.core.util.ext.use
import com.aman.vanish.core.util.ext.withProgress
import com.aman.vanish.core.util.progress.ProgressDeferred
import com.aman.vanish.download.ui.worker.DownloadSlowdownDispatcher
